...
export default function InvoiceSheet({ invoice }: InvoiceSheetProps) {
  ...
  return (
    <div id="printableInvoiceArea" className="printable-sheet max-w-4xl mx-auto p-8 sm:p-10 bg-white rounded-xl shadow-lg border border-slate-200">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-slate-200">
        <div className="flex items-center gap-4">
          <img 
            ...
            className="h-16 w-auto object-contain flex-none"
          />
          <div>
            <h1 className="text-xl font-extrabold text-slate-900 tracking-wide font-sans">FOR HEALTHCARE</h1>
            <p className="text-xs font-bold text-emerald-600 tracking-wider uppercase">Care · Compassion · Trust</p>
            <p className="text-xs text-slate-600 mt-1 font-medium">3rd, SUKRITHI # 1043, 2nd cross, main, BTM 4th Stage, Bilekahalli, Bengaluru, Karnataka 560076</p>
            <p className="text-xs text-slate-600">+91 81975 26597 | +91 99640 05780 &nbsp;|&nbsp; forhealthcare.forlife@gmail.com</p>
          </div>
        </div>

        <div className="text-right">
          <span className={`inline-block px-3 py-1 text-xs font-extrabold uppercase rounded-full tracking-wider ${
      ...
      {/* Invoice Banner */}
      <div className="bg-[#0b3d66] text-white font-extrabold text-center tracking-[3px] text-sm py-2 rounded-md my-4 uppercase">
        INVOICE / BILL
      </div>

      {/* Details Grid */}
      <div className="grid grid-cols-2 gap-6 text-xs text-slate-800 my-4">
        {/* Left Column */}
      ...
      {/* Services Table */}
      <table className="w-full text-xs border-collapse mt-6">
        <thead>
      ...
      {/* Signatures */}
      <div className="flex justify-between items-end mt-16 pt-4 text-xs text-slate-700">
